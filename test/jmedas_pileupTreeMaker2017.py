...
jetsCollections = {
	'AK4L1L2L3': 	{
					'algo': 'ak4',
					'pu_methods': ['Puppi','CHS'], #Options: {Puppi,CHS,''}
					'jec_payloads': ['AK4PFPuppi','AK4PFchs'], #Options: {AK4PFPuppi,AK4PFchs,AK4PF,AK8Calo,AK8JPT}
					'jec_levels': ['L1FastJet', 'L2Relative', 'L3Absolute'], #Options: {L1FastJet,L2Relative,L3Absolute,L2L3Residual,L5Flavor,L7Parton}
					},
	'AK8L1L2L3': 	{
					'algo': 'ak8',
					'pu_methods': ['Puppi','CHS'], #Options: {Puppi,CHS,''}
					'jec_payloads': ['AK8PFPuppi','AK8PFchs'], #Options: {AK8PFPuppi,AK8PFchs,AK8PF,AK8Calo,AK8JPT}
					'jec_levels': ['L1FastJet', 'L2Relative', 'L3Absolute'], #Options: {L1FastJet,L2Relative,L3Absolute,L2L3Residual,L5Flavor,L7Parton}
					},
				  }
...
for name, params in jetsCollectionsSorted.items():
	for index, pu_method in enumerate(params['pu_methods']):
		...
		if options.doJetToolbox:
			...
			path *= sequence *process.PUPPIMuonRelIso*pnm
